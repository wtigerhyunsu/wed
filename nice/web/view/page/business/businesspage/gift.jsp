		...
		<div class="tabbody" style="width: 100%">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active"
					data-toggle="tab" href="#kiosk1"> 키오스크 시스템 개요</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk2">키오스크도입장점</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk3">카드전용장비모델</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk4">현금/카드장비 겸용장비</a></li>
			</ul>
		</div>
			...
			<div class="tab-pane fade show active" id="kiosk1">
				...
				<table style="width: 100%">
					<tbody>
						<tr>
							<td><img alt="현금"
								src="img/product/kioskpage/product-ticket2-1.jpg"><p>현금(지폐 및 동전)</p></td>
							...
							<td><img alt="카드"
								src="img/product/kioskpage/product-ticket2-2.jpg"><p>신용, 직불카드</p></td>
						</tr>
						<tr>
							<td><img alt="전자화폐"
								src="img/product/kioskpage/product-ticket2-3.jpg"><p>전자화폐</p></td>
							<td><i class="fas fa-long-arrow-alt-right fa-4x"></i></td>
							<td><i
								class="fas fa-long-arrow-alt-right fa-4x fa-rotate-180"></i></td>
							<td><img alt="교통카드"
								src="img/product/kioskpage/product-ticket2-4.jpg"><p>교통카드</p></td>
