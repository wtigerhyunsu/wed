...
<link href="vendor/bootstrap/css/bootstrap.css?ver=3" rel="stylesheet">
<meta charset="utf-8">
<title>card</title>
...
<body>
	...
	<div class="local"  >
		...
		<h3>카드 단말기</h3>
		<p>여신전문금융업법에 의거하여 2015년 7월 21일부터 가맹점에 신규설치, 교체되는 단말기는 신용카드 단말기 정보보호 기술기준에 따른 보안인증 단말기를 의무적으로 사용해야 하며, IC카드 우선승인이 적용됩니다.</p>
		<div class="tabbody" style="width: 100%">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active"
					data-toggle="tab" href="#kiosk1"> 유선단말기</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk2">무선단말기</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk3">스마트폰 카드 리더기</a></li>
				<li class="nav-item"><a class="nav-link" data-toggle="tab"
					href="#kiosk4">사인패드</a></li>
			</ul>
		</div>
